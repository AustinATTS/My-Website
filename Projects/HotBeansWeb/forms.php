	...
	<html>
		<body style='background-color: #CCCCCC; padding-left: 20%; padding-top: 2.5%;'>
			<div style='display: flex; backgroun-color #333333'>
				<a href='http://localhost/HotBeansWebDevelopment/HotBeansWebDevelopment/index.html'>
					<img src='https://i.imgur.com/0ZQghL3.png' alt='Company Logo' style='max-width: 200px;'>
				</a>
				<h1 style='font-family: Segoe UI; color: #F76000; padding-left: 2.5%;'>Job Application Form Submission</h1>
			</div>
			<p style='padding-left: 5%; padding-top: 2.5%;'><strong>First Name:</strong> $first_name<br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['formApply'])) {
	...
	<html>
		<body style='background-color: #CCCCCC; padding-left: 20%; padding-top: 2.5%;'>
			...
			<br><strong>Reference/Comments/Questions:</strong><br><br>$reference</p>
		</body>
	</html>";
    if ($file_name !== "") {
